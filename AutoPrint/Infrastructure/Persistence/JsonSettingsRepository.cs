...
public sealed class JsonSettingsRepository : ISettingsRepository
{
    ...
    public JsonSettingsRepository(IHostEnvironment environment, IConfiguration configuration)
    {
        ...
        _current = File.Exists(_path)
            ...
            : new PrintOptions
            {
                PrinterName = configuration["AutoPrint:PrinterName"] ?? "",
                Simulation = configuration.GetValue("AutoPrint:Simulation", true),
                Paused = false,
                ...
                InboxFolder = configuration["AutoPrint:InboxFolder"] ?? "",
                InboxEnabled = configuration.GetValue("AutoPrint:InboxEnabled", false),
                DeleteInboxAfterPrint = configuration.GetValue("AutoPrint:DeleteInboxAfterPrint", false),
                Revision = 1,
